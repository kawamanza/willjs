...
setTimeout(function(){if(d.length&&!c.active)c.active=true,c.process()},5)}else if(d.length){a=d.shift();try{c.run.apply(c,a)!==false&&c.sched()}catch(e){throw c.sched(),e;}}else c.active=false}}}function r(a,b,c){if(b||!("cfg"in a))k.call(a,l.u.getConfig()),"call"in a||k.call(a,i);p(c)&&c(a.cfg)}function E(a,b){var c=b.packageName,c=a[c]||(a[c]={}),d=b.name;return c[d]||(c[d]={rescue:function(){}})}function w(a,b,c){var d=function(){return c.apply(a,arguments)},e="impl";n(c)&&(e=c,c=b[e]);b[e]=function(){var f=
arguments,g=b.assets||b.libs;if(g&&g.length)x(a,"loadDependenciesAndCall",[a,b,f]);else return b[e]=e=="impl"?d:c,b[e].apply(b,f)}}function y(a,b,c,d){if(!o(c)){var e=c.impl||p(c.getImpl)&&c.getImpl(a),f=c.assets||c.libs;if(p(e))b=E(b,d),b.assets=o(f)||!s(f)?[]:f,w(a,b,e),b.rescue=c.rescue||b.rescue;else for(e in c)d.name=e,y(a,b,c[e],d)}}function z(a,b,c){var a=a.cfg,d=a.domains,e="local",f=a.defaultPackage,g=b.toString();if(/^(?:(\w+):)?(?:(\w+)\.)?(\w+)$/.test(g))g=RegExp.$3,f=RegExp.$2||a.packages[g]||
f,e=RegExp.$1||e;d[e]||(e="local");return{format:c||d[e][0],domain:d[e][1],packageName:f,name:g,toString:function(){return e+":"+f+"."+g}}}function F(a,b,c){var a=a.cfg,d=b.packageName,e=b.name;if(c==j)c=a.mode;return b.domain+(c==l.modes.PROD?d:d==a.defaultPackage?e:d+"/"+e)+"."+b.format}function x(a,b,c){var a=a.cfg.processors,d=a[b];d||(d=a[b]=q(function(a){p(a)&&a()}));d.process(c)}function O(a,b){return function(){var c=arguments,d=z(a,b);x(a,"callComponent",[a,d,c])}}function G(a,b){var c={assets:b};
return function(b){if(!c.impl){var e,f;p(b)?(e=function(){b("success")},f=function(){b("error")}):e=f=function(){};w(a,c,e);c.rescue=f;c.impl()}}}var l,i={},C="data-willjs-id",K=/^([\w\-\.]+?)(?:\.min|\-\d+(?:\.\d+)*(?:\w+)?)*\.(?:css|js)$/,H=Array.prototype.slice,J=Object.prototype.toString,I=false,u=m.document;m[A]=l=new v(A);k.call(i,{call:function(a){return O(this,a)},use:function(a){return G(this,s(a)?a:H.call(arguments,0))},addComponent:function(a,b){return y(this,this.registry,b,z(this,a))},
addProcessor:function(a,b){this.cfg.processors[a]||(this.cfg.processors[a]=q(b))},process:function(a){x(this,a,H.call(arguments,1))},modes:{DEV:0,PROD:1},"u.extend":k,as:function(a){return!a?a:m[a]||(m[a]=new v(a,true))},configure:function(a){r(this,false,a);return this},reconfigure:function(a){r(this,true,a);return this}});k.call(v.prototype,i);i.u.loadComponent=function(a,b,c){I?c(500,""):a.use("//ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js")(function(d){d==="success"?(i.u.loadComponent=
D,D(a,b,c)):(I=true,c(500,""))})};i.u.extend({pathFor:z,urlFor:F,implWrapper:w,newProcessor:q,getConfig:function(){return{cfg:k.call(new this.Defaults,{processors:new this.Processors,domains:{local:["json","/javascripts/will/"]},packages:{}}),registry:{}}},Processors:function(){},Defaults:function(){}});(function(a){a.callComponent=q(function(a,c,d){var e=this,f=a.registry,g=F(a,c),h=E(f,c),i=h.impl;if(i)i.apply(j,d);else return c.format=="js"?(g=c.toString().replace(/[:\.]/g,"_")+"@"+g,G(a,[g])(function(a){try{if(a==
"success")(i=h.impl)&&i.apply(j,d)}finally{e.sched()}})):l.u.loadComponent(a,g,function(g,k){try{if(g!==200)throw"could not load component: "+c;n(k)&&(k=eval("("+k+")"));if(!o(k))y(a,f,k,c),(i=h.impl)&&i.apply(j,d)}finally{e.sched()}}),false});a.loadDependenciesAndCall=q(function(a,c,d){var e=this,f=a.cfg.debug,g=c.assets||c.libs,h;if(g.length)if(h=g[0],L(h))g.shift(),c.impl.apply(j,d);else return f&&f('** loading asset "'+h+'"'),N(a,h,c.lastCss,function(a,b){try{if(a==="success"){g.shift();if(b)c.lastCss=
b;c.impl.apply(j,d)}else c.rescue.apply(j,d)}finally{e.sched()}}),false;else c.impl.apply(j,d)})})(i.u.Processors.prototype);k.call(i.u.Defaults.prototype,{mode:l.modes.DEV,version:"1.1",addDomain:function(a,b,c){this.domains[a]=[c?"js":"json",b+(/\/$/.test(b)?"":"/")]},defaultPackage:"root",registerPackage:function(a,b){var c=b.split(/,/),d,e,f;d=this.packages;for(f=0,e=c.length;f<e;)d[c[f++]]=a}});r(l,false)})(window,"will",null);
