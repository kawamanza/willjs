/*! WillJS v1.8.0 | github.com/kawamanza/willjs/ */
...
l=RegExp.$1||"local");e=e[l]||e.local||{};m(this,{domainName:l,packageName:g,name:b,version:c||"latest",base:e.domain,format:e.format||"json",prod:(e.mode||d.mode||f.DEV)==f.PROD,ctx:a})}function I(a,b,c){a=a.cfg.processors;var d=a[b];d||(d=a[b]=new x(function(a){r(a)&&a()}));d.process(c)}function S(a,b,c){var d={assets:b};return function(b,f){if(!d.impl){var l,g;r(b)?(l=function(){b("success")},g=function(){b("error")}):l=g=function(){};R(a,d,l);d.dir=f;d.rescue=g;d.removeElement=c;d.impl()}}}function H(){}
function Q(){}var G,u={},Y=/\.css$/,ea=/\.js$/,Z=/\/+/,aa=/^[\^\+]?(?:\w+:|)$/,K=/^(?:[^@]+@)?\|/,$=/^([\w\-\.]+?)(?:\.min|\-\d+(?:\.\d+)*(?:\.?\w+)?)*\.(?:css|js)$/,W=/^(?:([\w\-\.]+)\@)?([^#\?]+)(?:(\?[^#]*))?/,T=/^[\w\-]+$/,fa=/^(?:(\w+):)?(?:(\w+)\.)?(\w+)$/,L=Array.prototype.slice,U=Object.prototype.toString,X=v.location.protocol,q=v.document;m(x.prototype,{sched:function(){var a=this;setTimeout(function(){a.process()},0)},process:function(a){var b=this,c=b.queue;if(arguments.length){if(y(a)||
!t(a))a=[a];c.push(a);setTimeout(function(){c.length&&!b.active&&(b.active=!0,b.process())},2)}else if(c.length){a=c.shift();try{!1!==b.run.apply(b,a)&&b.sched()}catch(d){throw b.sched(),d;}}else b.active=!1}});m(A.prototype,{"dir!":function(){var a=this._dir(),b;if(/\{/.test(a)){var c=a.match(/([^\{]+|\{[^\}]+\})/gm),d=c.length;for(b=0;b<d;b++)a=c[b],"{"==a.charAt(0)&&(c[b]=this[a.substr(1,a.length-2)]||a);a=c.join("")}return a},_dir:function(){var a=this.ctx,b=this.packageName;return(this.base||
a.info.dom)+(this.prod||b==a.cfg.defaultPackage?"":b+"/")},"url!":function(){return this.dir+(this.prod?this.packageName:this.name)+"."+this.format},"entry!":function(){var a=this.ctx.registry,b=this.domainName,c=this.packageName,a=a[b]||(a[b]={}),c=a[c]||(a[c]={}),a=this.name;return c[a]||(c[a]={rescue:function(){},dir:this.dir})},toString:function(){return this.domainName+":"+this.packageName+"."+this.name}});m(u,{use:function(a){return S(this,t(a)?a:L.call(arguments,0),!1)},addComponent:function(a,
b){1==arguments.length&&(b=a,a=new A(this,"unknown"));J(this,b,a)},define:function(a,b,c){r(b)&&(c=b,b=[]);this.addComponent(a,{assets:b,getResponder:c})},addProcessor:function(a,b){var c=this.cfg.processors;c[a]||(c[a]=new x(b))},process:function(a){I(this,a,L.call(arguments,1))},modes:{DEV:2,PROD:1},as:function(a){return a?v[a]||(v[a]=new w(a)):a},configure:function(a){this.configured=!0;P(this,a);return this},dir:function(a,b){b||(b=a,a=this.info.dir);a+=/\/$/.test(a)?"":"/";a=D("script",{src:a+
b}).src;return a=a.replace(/%7[bB]/g,"{").replace(/%7[dD]/g,"}")},":info!":function(){var a=this._info,b,c,d,e;if(!a)for(b=q.getElementsByTagName("script"),B||(B="will"),d=0,c=b.length;d<c;d++)if(e=new E(b[d]),e.id==B){b=e.href;this._info=a={href:b,qs:e.qs,min:/\.min\.js/.test(b),dir:b=b.replace(/\/(?:will\/)*[^\/]+$/,"/will/"),dom:b+"components/"};break}return a}});m(u,"u",{hit:O,Processors:H,Processor:x,Path:A,process:I,requireAssets:S,registerFunctions:J,extend:m});m(w.prototype,u);m(Q.prototype,
{mode:u.modes.DEV,version:"1.8.0",addDomain:function(a,b,c,d){b&&(b+=/\/$/.test(b)?"":"/");this.domains[a]={format:s(c)?c:c?"js":"json",domain:b,mode:d}},addAssetsList:function(a){if(!T.test(a))throw Error("invalid term: "+a);this.assetsList[a]=L.call(arguments,1)},translateAssetTo:function(a,b){s(b)&&(b=b.split(","));t(a)||(a=[a]);for(var c=this.assetsTargetList,d=0,e=b.length,f,c=c[/\.css/.test(a[0])?"css":"js"];d<e;)f=b[d++],-1==a.indexOf(f)&&(c[f]=a)},defaultPackage:"root",registerPackage:function(a,
b){var c=b.split(/,/),d,e,f;d=this.packages;f=0;for(e=c.length;f<e;)d[c[f++]]=a}});H.prototype.loadDependenciesAndCall=new x(function(a,b,c){var d=this,e=a.cfg,f=e.assetsList,l=e.assetsTargetList,e=e.debug,g,h=b.assets,k=b.dir,n,m;if(h.length){if(T.test(g=h[0]))if(t(g=f[g])){n=0;for(f=g.length;n<f;n++)if(/\.css(?:[?#].*)?$/.test(g[n])){/\^/.test(g[n])&&(delete b.bottomCss,delete b.lastCss);break}g=g.slice(0);g.splice(0,0,0,1);h.splice.apply(h,g)}else{b.rescue.apply(p,c);return}g=new E(h[0],k);m=g.pre;
f=g.pos;if(k=ba(g)){h.shift();if(k[0]){if(a=b.lastCss)l=b.bottomCss.nextSibling,m&&N(a,k[1])?z(k[1],a):l&&N(k[1],b.bottomCss)&&z(k[1],l);a&&m||(b.bottomCss=k[1]);b.lastCss=k[1]}for(;h.length&&K.test(h[0]);)h.shift();b.impl.apply(p,c)}else if(k=l[g.css?"css":"js"][g.id])e&&e('** skipping asset "'+g.href+'"'),h.splice.apply(h,[0,1].concat(k)),b.impl.apply(p,c);else return e&&e('** loading asset "'+g.href+'"'),f&&(k=q.getElementsByTagName(g.tn),0!=(f=k.length)&&(b.lastCss=b.bottomCss=k[f-1])),da(a,g,
b[m?"lastCss":"bottomCss"],function(a,e){try{if(1<h.length&&K.test(h[1]))if("success"===a){do h.shift();while(1<h.length&&K.test(h[1]))}else h[1]=h[1].replace(/\|/,""),a="success";"success"===a?(h.shift(),e&&(b.lastCss&&m||(b.bottomCss=e),b.lastCss=e),b.impl.apply(p,c)):b.rescue.apply(p,c)}finally{d.sched()}},b.removeElement),!1}else b.impl.apply(p,c)});v[M]=G=new w(M);P(G);u.u.hit("loadComponent","componentLoader.js");O.call(w.prototype,"call","callComponent.js",!0)})(window,"will",null);
